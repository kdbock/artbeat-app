...
echo "Updating feature modules..."
for module in artbeat_messaging artbeat_admin artbeat_artwork artbeat_artist artbeat_community artbeat_settings artbeat_profile artbeat_art_walk artbeat_capture; do
