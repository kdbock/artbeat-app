...
show_help() {
  ...
  echo -e "  ./scripts/run_module.sh [options] <module_name|number>"
  echo ""
  ...
  echo -e "  ./scripts/run_module.sh auth                  # Run auth module (artbeat_auth)"
  echo -e "  ./scripts/run_module.sh artbeat_profile       # Run profile module"
  echo -e "  ./scripts/run_module.sh -e -r artwork         # Run artwork module with emulators in release mode"
  echo -e "  ./scripts/run_module.sh -d chrome community   # Run community module in Chrome browser"
  echo ""
  show_modules
  exit 0
}
