...
class GalleryInvitationService {
  ...
  Future<String> sendInvitation({
    ...
    try {
      ...
      final artistProfile =
          await _subscriptionService.getArtistProfileById(artistProfileId);
  ...
  Future<List<String>> sendBulkInvitations({
    ...
    for (final artistId in artistProfileIds) {
      try {
        ...
        print('Error sending invitation to artist $artistId: $e');
  ...
  Future<void> cancelInvitation(String invitationId) async {
    ...
    try {
      ...
      final galleryProfile =
          await _subscriptionService.getCurrentArtistProfile();
      if (galleryProfile == null ||
          galleryProfile.id != invitationData['galleryId']) {
      ...
      await _notificationService.sendNotification(
        ...
        body: '${galleryProfile.displayName} has cancelled their invitation',
