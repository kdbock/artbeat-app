...
class RouteUtils {
  ...
  static Route<dynamic> createRoute({required Widget child}) {
    return MaterialPageRoute(builder: (_) => child);
  }

  /// Creates a route with the main app layout (includes drawer, app bar, etc.)
  static Route<dynamic> createMainLayoutRoute({required Widget child}) {
    return MaterialPageRoute(builder: (_) => child);
  }

  /// Creates a simple route without app layout
  static Route<dynamic> createSimpleRoute({required Widget child}) {
    return MaterialPageRoute(builder: (_) => child);
  }
  ...
  static T? getArgument<T>(RouteSettings settings) {
