...
import 'package:artbeat/models/favorite_model.dart';
...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  Future<void> _loadFavorites() async {
    ...
    try {
      final favorites = await _userService.getUserFavorites(widget.userId);
      if (!mounted) return;

      setState(() {
        _favorites =
            favorites
                .map((f) => FavoriteModel.fromMap(f, f['id'] as String))
                .toList();
        _isLoading = false;
      });
    } catch (e) {
