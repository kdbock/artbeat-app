...
class _ArtistDashboardScreenState extends State<ArtistDashboardScreen>
              ...
              children: [
                Icon(
                  _subscription?.tier == SubscriptionTier.free
                      ? Icons.star_border
                      : Icons.star,
                  color: _subscription?.tier == SubscriptionTier.premium
                      ? Colors.amber
  ...
  Widget _buildProfileCompletionTracker() {
    ...
    if (profile.facebook != null && profile.facebook!.isNotEmpty) totalSocial++;
    if (profile.twitter != null && profile.twitter!.isNotEmpty) totalSocial++;
    if (profile.etsy != null && profile.etsy!.isNotEmpty) totalSocial++;
    ...
    return Column(
      ...
      children: [
        ...
        if (_subscription != null &&
            (_subscription!.tier == SubscriptionTier.standard ||
                _subscription!.tier == SubscriptionTier.premium))
