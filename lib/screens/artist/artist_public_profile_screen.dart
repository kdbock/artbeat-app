...
class _ArtistPublicProfileScreenState extends State<ArtistPublicProfileScreen> {
                    ...
                    child: Row(
                      ...
                      children: [
                        if (artist.websiteUrl != null &&
                            artist.websiteUrl!.isNotEmpty)
                          IconButton(
                            onPressed: () => _launchUrl(artist.websiteUrl),
                            icon: const Icon(Icons.language),
                            tooltip: 'Website',
                          ),
                        if (artist.instagram != null &&
                            artist.instagram!.isNotEmpty)
                          IconButton(
                        ...
                        if (artist.etsy != null && artist.etsy!.isNotEmpty)
                          IconButton(
                            onPressed: () => _launchUrl(artist.etsy),
  ...
  Widget _buildArtworkItem(ArtworkModel artwork) {
    return InkWell(
      onTap: () {
        Navigator.pushNamed(
          context,
