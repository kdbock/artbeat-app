...
class _ArtistBrowseScreenState extends State<ArtistBrowseScreen> {
  ...
  Future<void> _loadArtists() async {
    ...
    try {
      // Load all artists, premium artists first
      final artists = await _subscriptionService.searchArtists(
        query: _searchQuery,
          ...
          children: [
            ...
            Stack(
              ...
              children: [
                ...
                // Premium badge
                if (artist.subscriptionTier != SubscriptionTier.free)
                  Positioned(
                    top: 10,
                    right: 10,
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            artist.subscriptionTier == SubscriptionTier.premium
                                ? Colors.amber
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      if (artist.userType == UserType.gallery)
                        Chip(
