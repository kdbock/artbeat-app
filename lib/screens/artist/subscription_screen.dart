...
import 'package:artbeat/screens/artist/subscription_comparison_screen.dart';
import 'package:artbeat/screens/artist/refund_request_screen.dart';
...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
  ...
  Future<void> _loadSubscription() async {
    ...
    try {
      ...
      // Load payment history for subscription
      ...
      if (mounted) {
        setState(() {
          ...
          _selectedTier = subscription?.tier ?? SubscriptionTier.free;
  ...
  Future<void> _loadPaymentHistory(String userId) async {
    try {
      final paymentDocs = await _subscriptionService.getPaymentHistory(userId);
      setState(() {
  ...
  Future<void> _subscribe() async {
    ...
    try {
      // Check if this is an upgrade/downgrade or a new subscription
      if (_currentSubscription != null &&
          _currentSubscription!.isActive &&
          _selectedTier != _currentSubscription!.tier) {
        // This is a tier change
        await _changeTier();
      } else {
        ...
        if (result == true) {
          // Payment was successful, reload subscription
  ...
  Widget _buildCurrentSubscription() {
    ...
    final startDate = _formatDate(_currentSubscription!.startDate);
    final endDate = _formatDate(_currentSubscription!.endDate);
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              trailing: _currentSubscription!.tier != SubscriptionTier.free
                  ? TextButton(
