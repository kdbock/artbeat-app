...
class _SubscriptionAnalyticsScreenState
  ...
  String _selectedRange = 'all_time';
  ...
  Future<Map<String, dynamic>> _getSubscriptionDetails(
    ...
    details['isActive'] = subscription.isActive;
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      formatter.format(_subscription!.endDate),
                      style: const TextStyle(fontWeight: FontWeight.bold),
                    ),
                  ],
                ),
                    ...
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        if (value.toInt() >= 0 &&
                          ...
                          final parts = dates[value.toInt()].split('-');
                          if (parts.length >= 3) {
                            // Show month and day
