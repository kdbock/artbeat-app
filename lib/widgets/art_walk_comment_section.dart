...
class _ArtWalkCommentSectionState extends State<ArtWalkCommentSection> {
  ...
  Future<void> _deleteComment(String commentId) async {
    ...
    try {
      await _artWalkService.deleteArtWalkComment(widget.artWalkId, commentId);
      await _loadComments();
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _toggleCommentLike(String commentId) async {
    ...
    try {
      await _artWalkService.toggleCommentLike(widget.artWalkId, commentId);
      await _loadComments();
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
                                ...
                                children: replies.map<Widget>((reply) {
                                  final replyCreatedAt =
                                      (reply['createdAt'] as Timestamp?)
                                          ?.toDate();
                                  final replyTimeAgo = replyCreatedAt != null
