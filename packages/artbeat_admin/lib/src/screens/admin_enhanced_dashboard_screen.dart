        ...
        GridView.count(
          ...
          children: [
            _buildKPICard(
              'Total Revenue',
              _analytics != null
                  ? _formatCurrency(_analytics!.financialMetrics.totalRevenue)
                  : '\$0',
              Icons.attach_money,
              Colors.green,
              changeValue: _analytics?.financialMetrics.revenueGrowth,
            ),
            _buildKPICard(
              'Active Users',
        ...
        Wrap(
          ...
          children: [
            ...
            _buildActionButton(
              ...
              () => Navigator.of(context).push(
                MaterialPageRoute<void>(
                  builder: (context) => const AdminFinancialAnalyticsScreen(),
                ),
              ),
            ),
            _buildActionButton(
      ...
      children: [
        GridView.count(
          ...
          children: [
            ...
            _buildKPICard(
              'Storage Used',
              _analytics != null ? _formatBytes(_analytics!.storageUsed) : '0B',
              Icons.storage,
              Colors.orange,
