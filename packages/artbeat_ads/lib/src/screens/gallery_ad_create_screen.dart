...
class GalleryAdCreateScreen extends StatefulWidget {
  ...
  @override
  State<GalleryAdCreateScreen> createState() => _GalleryAdCreateScreenState();
}

class _GalleryAdCreateScreenState extends State<GalleryAdCreateScreen> {
  ...
  void _submitAd() async {
    ...
    try {
      ...
      final service = AdGalleryService();
      await service.createGalleryAd(ad);
      if (mounted) {
