...
class _EventsDashboardScreenState extends State<EventsDashboardScreen> {
  ...
  Future<void> _loadEvents() async {
    try {
      ...
      developer.log('DEBUG: All events query returned ${allEventsQuery.docs.length} documents');
      ...
      developer.log('DEBUG: Public events query returned ${publicEventsQuery.docs.length} documents');
      ...
      for (var event in events) {
        developer.log('DEBUG: Event: ${event.title} at ${event.startDate}');
      }
  ...
  Widget _buildEventCard(BuildContext context, EventModel event) {
    final bool isHappeningNow =
        ...
        (event.endDate == null || event.endDate!.isAfter(DateTime.now()));
