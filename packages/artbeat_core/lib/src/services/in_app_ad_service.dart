...
/// Service for handling ad-specific in-app purchases using fixed package system
class InAppAdService {
  ...
  // Fixed ad package configurations - Apple IAP compliant
  static const Map<String, Map<String, dynamic>> _adProducts = {
    // Basic Packages (7 days)
    'ad_basic_premium_small': {
      'amount': 14.99,
      'title': 'Basic Premium Small',
      'description': 'Small ad in premium zones for 7 days',
      'duration_days': 7,
      'zone_group': 'premium',
      'size': 'small',
      'features': ['Premium zone placement', 'High visibility'],
    },
    'ad_basic_premium_medium': {
      'amount': 24.99,
      'title': 'Basic Premium Medium',
      'description': 'Medium ad in premium zones for 7 days',
      'duration_days': 7,
      'zone_group': 'premium',
      'size': 'medium',
      'features': ['Premium zone placement', 'Enhanced visibility'],
    },
    'ad_basic_premium_large': {
      'amount': 34.99,
      'title': 'Basic Premium Large',
      'description': 'Large ad in premium zones for 7 days',
      'duration_days': 7,
      'zone_group': 'premium',
      'size': 'large',
      'features': ['Premium zone placement', 'Maximum impact'],
    },
    'ad_basic_standard_small': {
      'amount': 9.99,
      'title': 'Basic Standard Small',
      'description': 'Small ad in standard zones for 7 days',
      'duration_days': 7,
      'zone_group': 'standard',
      'size': 'small',
      'features': ['Targeted placement', 'Cost-effective'],
    },
    'ad_basic_standard_medium': {
      'amount': 19.99,
      'title': 'Basic Standard Medium',
      'description': 'Medium ad in standard zones for 7 days',
      'duration_days': 7,
      'zone_group': 'standard',
      'size': 'medium',
      'features': ['Targeted placement', 'Good visibility'],
    },
    'ad_basic_standard_large': {
      'amount': 29.99,
      'title': 'Basic Standard Large',
      'description': 'Large ad in standard zones for 7 days',
      'duration_days': 7,
      'zone_group': 'standard',
      'size': 'large',
      'features': ['Targeted placement', 'High impact'],
    },
    'ad_basic_budget_small': {
      'amount': 4.99,
      'title': 'Basic Budget Small',
      'description': 'Small ad in budget zone for 7 days',
      'duration_days': 7,
      'zone_group': 'budget',
      'size': 'small',
      'features': ['Niche targeting', 'Budget-friendly'],
    },
    'ad_basic_budget_medium': {
      'amount': 14.99,
      'title': 'Basic Budget Medium',
      'description': 'Medium ad in budget zone for 7 days',
      'duration_days': 7,
      'zone_group': 'budget',
      'size': 'medium',
      'features': ['Niche targeting', 'Good value'],
    },
    'ad_basic_budget_large': {
      'amount': 24.99,
      'title': 'Basic Budget Large',
      'description': 'Large ad in budget zone for 7 days',
      'duration_days': 7,
      'zone_group': 'budget',
      'size': 'large',
      'features': ['Niche targeting', 'Maximum impact'],
    },

    // Standard Packages (14 days)
    'ad_standard_premium_small': {
      'amount': 29.99,
      'title': 'Standard Premium Small',
      'description': 'Small ad in premium zones for 14 days',
      'duration_days': 14,
      'zone_group': 'premium',
      'size': 'small',
      'features': ['Premium zones', 'Extended duration'],
    },
    'ad_standard_premium_medium': {
      'amount': 49.99,
      'title': 'Standard Premium Medium',
      'description': 'Medium ad in premium zones for 14 days',
      'duration_days': 14,
      'zone_group': 'premium',
      'size': 'medium',
      'features': ['Premium zones', 'Great visibility'],
    },
    'ad_standard_premium_large': {
      'amount': 69.99,
      'title': 'Standard Premium Large',
      'description': 'Large ad in premium zones for 14 days',
      'duration_days': 14,
      'zone_group': 'premium',
      'size': 'large',
      'features': ['Premium zones', 'Maximum exposure'],
    },
    'ad_standard_standard_small': {
      'amount': 19.99,
      'title': 'Standard Standard Small',
      'description': 'Small ad in standard zones for 14 days',
      'duration_days': 14,
      'zone_group': 'standard',
      'size': 'small',
      'features': ['Targeted placement', 'Extended reach'],
    },
    'ad_standard_standard_medium': {
      'amount': 39.99,
      'title': 'Standard Standard Medium',
      'description': 'Medium ad in standard zones for 14 days',
      'duration_days': 14,
      'zone_group': 'standard',
      'size': 'medium',
      'features': ['Targeted placement', 'Strong visibility'],
    },
    'ad_standard_standard_large': {
      'amount': 59.99,
      'title': 'Standard Standard Large',
      'description': 'Large ad in standard zones for 14 days',
      'duration_days': 14,
      'zone_group': 'standard',
      'size': 'large',
      'features': ['Targeted placement', 'High impact'],
    },
    'ad_standard_budget_small': {
      'amount': 9.99,
      'title': 'Standard Budget Small',
      'description': 'Small ad in budget zone for 14 days',
      'duration_days': 14,
      'zone_group': 'budget',
      'size': 'small',
      'features': ['Budget-friendly', 'Extended duration'],
    },
    'ad_standard_budget_medium': {
      'amount': 29.99,
      'title': 'Standard Budget Medium',
      'description': 'Medium ad in budget zone for 14 days',
      'duration_days': 14,
      'zone_group': 'budget',
      'size': 'medium',
      'features': ['Great value', 'Extended reach'],
    },
    'ad_standard_budget_large': {
      'amount': 49.99,
      'title': 'Standard Budget Large',
      'description': 'Large ad in budget zone for 14 days',
      'duration_days': 14,
      'zone_group': 'budget',
      'size': 'large',
      'features': ['Excellent value', 'Strong impact'],
    },

    // Premium Packages (30 days)
    'ad_premium_premium_small': {
      'amount': 59.99,
      'title': 'Premium Premium Small',
      'description': 'Small ad in premium zones for 30 days',
      'duration_days': 30,
      'zone_group': 'premium',
      'size': 'small',
      'features': ['Top placement', 'Long-term exposure'],
    },
    'ad_premium_premium_medium': {
      'amount': 99.99,
      'title': 'Premium Premium Medium',
      'description': 'Medium ad in premium zones for 30 days',
      'duration_days': 30,
      'zone_group': 'premium',
      'size': 'medium',
      'features': ['Top placement', 'Maximum reach'],
    },
    'ad_premium_premium_large': {
      'amount': 139.99,
      'title': 'Premium Premium Large',
      'description': 'Large ad in premium zones for 30 days',
      'duration_days': 30,
      'zone_group': 'premium',
      'size': 'large',
      'features': ['Elite placement', 'Ultimate exposure'],
    },
    'ad_premium_standard_small': {
      'amount': 39.99,
      'title': 'Premium Standard Small',
      'description': 'Small ad in standard zones for 30 days',
      'duration_days': 30,
      'zone_group': 'standard',
      'size': 'small',
      'features': ['Sustained targeting', 'Long campaign'],
    },
    'ad_premium_standard_medium': {
      'amount': 79.99,
      'title': 'Premium Standard Medium',
      'description': 'Medium ad in standard zones for 30 days',
      'duration_days': 30,
      'zone_group': 'standard',
      'size': 'medium',
      'features': ['Strong presence', 'Extended campaign'],
    },
    'ad_premium_standard_large': {
      'amount': 119.99,
      'title': 'Premium Standard Large',
      'description': 'Large ad in standard zones for 30 days',
      'duration_days': 30,
      'zone_group': 'standard',
      'size': 'large',
      'features': ['Dominant presence', 'Maximum impact'],
    },
    'ad_premium_budget_small': {
      'amount': 19.99,
      'title': 'Premium Budget Small',
      'description': 'Small ad in budget zone for 30 days',
      'duration_days': 30,
      'zone_group': 'budget',
      'size': 'small',
      'features': ['Long-term value', 'Sustained reach'],
    },
    'ad_premium_budget_medium': {
      'amount': 59.99,
      'title': 'Premium Budget Medium',
      'description': 'Medium ad in budget zone for 30 days',
      'duration_days': 30,
      'zone_group': 'budget',
      'size': 'medium',
      'features': ['Outstanding value', 'Strong presence'],
    },
    'ad_premium_budget_large': {
      'amount': 99.99,
      'title': 'Premium Budget Large',
      'description': 'Large ad in budget zone for 30 days',
      'duration_days': 30,
      'zone_group': 'budget',
      'size': 'large',
      'features': ['Ultimate value', 'Maximum impact'],
    },
  };
