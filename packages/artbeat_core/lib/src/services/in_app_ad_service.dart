...
class InAppAdService {
  ...
  // These match the App Store Connect product IDs exactly
  static const Map<String, Map<String, dynamic>> _adProducts = {
    // Small ad packages
    'ad_small_1w': {
      'amount': 9.99,
      'title': 'Small Ad - 1 Week',
      'description': 'Small advertisement for 1 week',
      'duration_days': 7,
      'size': 'small',
      'features': ['Standard placement', '1 week duration'],
    },
    'ad_small_1m': {
      'amount': 24.99,
      'title': 'Small Ad - 1 Month',
      'description': 'Small advertisement for 1 month',
      'duration_days': 30,
      'size': 'small',
      'features': ['Standard placement', '1 month duration'],
    },
    'ad_small_3m': {
      'amount': 59.99,
      'title': 'Small Ad - 3 Months',
      'description': 'Small advertisement for 3 months',
      'duration_days': 90,
      'size': 'small',
      'features': ['Standard placement', '3 months duration', 'Best value'],
    },
    // Big ad packages
    'ad_big_1w': {
      'amount': 19.99,
      'title': 'Big Ad - 1 Week',
      'description': 'Large advertisement for 1 week',
      'duration_days': 7,
      'size': 'big',
      'features': ['Premium placement', '1 week duration', 'High visibility'],
    },
    'ad_big_1m': {
      'amount': 49.99,
      'title': 'Big Ad - 1 Month',
      'description': 'Large advertisement for 1 month',
      'duration_days': 30,
      'size': 'big',
      'features': ['Premium placement', '1 month duration', 'Maximum impact'],
    },
    'ad_big_3m': {
      'amount': 119.99,
      'title': 'Big Ad - 3 Months',
      'description': 'Large advertisement for 3 months',
      'duration_days': 90,
      'size': 'big',
      'features': ['Premium placement', '3 months duration', 'Ultimate value'],
    },
  };
