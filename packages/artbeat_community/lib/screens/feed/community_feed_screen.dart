...
class _CommunityFeedScreenState extends State<CommunityFeedScreen> {
  ...
  Future<void> _loadFeed() async {
    ...
    try {
      ...
      _lastDocument = postsSnapshot.docs.isNotEmpty
          ? postsSnapshot.docs.last
          : null;
    ...
    try {
      ...
      if (currentApplause < PostModel.maxApplausePerUser) {
        ...
        await FirebaseFirestore.instance.runTransaction((transaction) async {
          ...
          ); // Use merge to prevent document not found errors
            ...
            child: Column(
              ...
              children: [
                DropdownButton<String>(
                  value: selectedType,
                  items: ['Appreciation', 'Critique', 'Question', 'Tip'].map((
                    String value,
                  ) {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(onPressed: _loadFeed, child: const Text('Refresh')),
          ],
        ),
      );
    }
  ...
  Future<void> _createSamplePost() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Error creating post: ${e.toString().split('] ').last}',
          ),
        ),
      );
    }
