...
class CommunityComponents {
  ...
  CardThemeData get cardTheme => CardThemeData(
    ...
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(CommunitySpacing.canvasBorderRadius),
    ),
  ...
  OutlinedButtonThemeData get feedbackButtonTheme => OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      ...
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
      side: const BorderSide(color: CommunityColors.feedback, width: 1.5),
    ),
  );
  ...
  DividerThemeData get dividerTheme => DividerThemeData(
    ...
    thickness: 1,
    color: CommunityColors.canvasBorder.withValues(alpha: 0.2),
  );
}
...
class CommunityThemeWrapper extends StatelessWidget {
  ...
  const CommunityThemeWrapper({super.key, required this.child});
