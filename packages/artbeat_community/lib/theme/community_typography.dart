...
class CommunityTypography {
  ...
  TextStyle get studioDescription =>
      theme.textTheme.bodyLarge!.copyWith(color: Colors.black87, height: 1.5);
  ...
  TextStyle get feedPostBody =>
      theme.textTheme.bodyLarge!.copyWith(height: 1.6, letterSpacing: 0.15);
  ...
  TextStyle get commentText =>
      theme.textTheme.bodyMedium!.copyWith(height: 1.4, letterSpacing: 0.25);
