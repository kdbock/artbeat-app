...
/// Community Package Specific Header
///
/// Color: #2acaaa (42, 202, 170)
...
class _CommunityHeaderState extends State<CommunityHeader> {
  static const Color _headerColor = Color(0xFF2ACAAA); // Community header color
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Menu items for community package
            ListTile(
            ...
            ListTile(
              leading: const Icon(Icons.group_add, color: _headerColor),
              title: const Text('Find People'),
              onTap: () {
                Navigator.pop(context);
                Navigator.pushNamed(context, '/community/discover');
              },
            ),
            ListTile(
              leading: const Icon(Icons.forum, color: _headerColor),
              title: const Text('Discussions'),
              onTap: () {
                Navigator.pop(context);
                Navigator.pushNamed(context, '/community/discussions');
              },
            ),
  ...
  void _showDeveloperMenu() {
    // Show developer tools specific to community package
    showDialog<void>(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Community Developer Tools'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            ListTile(
              title: const Text('Test Feed Updates'),
              onTap: () {
                Navigator.pop(context);
                // Implement feed update testing
              },
            ),
            ListTile(
              title: const Text('Clear Community Cache'),
              onTap: () {
                Navigator.pop(context);
                // Implement community cache clearing
              },
            ),
          ],
        ),
